...
test2_csv=pd.read_csv(path + "test.csv", index_col=0)
...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.8, shuffle=True, random_state=1186)
...
# 최종 loss :  21858.919921875
# ACC :  0.3342294692993164