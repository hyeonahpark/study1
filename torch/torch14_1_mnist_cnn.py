...
class CNN(nn.Module) : #클래스 괄호 안에는 상속
    def __init__(self, num_features):
        ...
        self.hidden_layer1 = nn.Sequential(
            nn.Conv2d(num_features, 64, kernel_size=(3,3), strude=1), #(n, 64, 54, 54)
        ...
        self.hidden_layer2 = nn.Sequential(
            nn.Conv2d(64, 32,  kernel_size=(3,3), strude=1), #(n, 32, 25, 25)
            nn.ReLU(),
        ...
        self.hidden_layer3 = nn.Sequential(
            nn.Conv2d(32, 16, kernel_size=(3,3), strude=1), #(n, 16, 10, 10)
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(2,2)), #(n, 16, 5, 5)
            nn.Dropout(0.5)
        )
        
        self.hidden_layer4 = nn.Sequential(16*5*5, 16)
...
# 최종 loss :  0.2503382595507043
# acc :  0.9690495207667732
