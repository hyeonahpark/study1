...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.9, shuffle=True, random_state=1005)
...
class Model(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.linear1 = nn.Linear(input_dim, 251)
        self.linear2 = nn.Linear(251, 141)
        self.linear3 = nn.Linear(141, 171)
        self.linear4 = nn.Linear(171, 14)
        self.linear5 = nn.Linear(14, output_dim)
        self.relu = nn.ReLU()
...
acc = r2_score(y_test.detach().cpu().numpy(), y_pre.detach().cpu().numpy())
print('ACC : ', acc)

# 최종 loss :  4192.64208984375
# ACC :  0.25724124908447266