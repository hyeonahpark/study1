...
train_dataset = FashionMNIST(path, train = True, download= False, transform=transf) #다운로드 (토치는 다운로드 받아줘야함! 케라스는 안받아도 됨)
test_dataset = FashionMNIST(path, train = False, download= False, transform=transf)  #다운로드 안됨.
...
#최종 loss :  0.2919407758159569
#acc :  0.8939696485623003