...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, shuffle=True, random_state=1186, train_size=0.9,
                                                    )

# print(x_train.shape, y_train.shape) #(160, 13) (160,)
...
def build_model(drop=0.5, optimizer='adam', activation='relu',
    ...
    inputs= Input(shape=(13, ), name='input1')
...
PATH_SAVE = 'C:\\ai5\\_save\\keras71\\k71_06\\'
...
# 걸린 시간 : 85.66
# model.best_params_ :  {'optimizer': 'adam', 'node5': 64, 'node4': 16, 'node3': 16, 'node2': 32, 'node1': 128, 'drop': 0.2, 'batch_size': 32, 'activation': 'selu'}
# model.best_scroe : -0.037720922380685806
# r2_score :  0.9625775218009949