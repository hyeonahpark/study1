...
for i in range(0, len(lr), 1) :
    ...
    path_save = 'C:\\ai5\\_save\\keras68\\k68_04\\'
    filename ='{epoch:04d}-{val_loss:.4f}.hdf5'   #1000-0.7777.hdf5
    filepath = "".join([path_save, 'k68_04_', str(i+1), '_', date, '_' , filename])
    ...
    hist=model.fit(x_train, y_train, epochs=1000, batch_size=32, verbose=0, validation_split=0.3, callbacks=[es, mcp])
    end_time=time.time()
