...
path = 'C:\\ai5\\_save\\keras69\\k69_10\\'
filename ='{epoch:04d}-{val_loss:.4f}.hdf5'   #1000-0.7777.hdf5
filepath = "".join([path, 'k69_10', date, '_' , filename])
...
model.fit(x_train, y_train, epochs=1000, batch_size=512, validation_split=0.2, callbacks=[es, mcp, rlr])
end_time = time.time()
...
# loss : 0.6722845435142517
# RMSE : 1.6810193465586605