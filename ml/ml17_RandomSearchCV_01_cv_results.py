...
#최적의 매개변수 :  XGBClassifier(C=1, base_score=None, booster=None, callbacks=None,
            ...
            #   interaction_constraints=None, kernel='rbf', learning_rate=0.1,
            #   max_bin=None, max_cat_threshold=None, max_cat_to_onehot=None,
            #   max_delta_step=None, max_depth=None, max_leaves=None,
            #   min_child_weight=None, missing=nan, monotone_constraints=None,
            #   multi_strategy=None, n_estimators=None, n_jobs=None, ...)
            
print("최적의 파라미터 : ", model.best_params_) # 최적의 파라미터 :  {'learning_rate': 0.1, 'kernel': 'rbf', 'gamma': 0.1, 'C': 1}
print("best_score : ", model.best_score_) # best_score :  0.975
print("model.score : ", model.score(x_test, y_test)) # model.score :  0.9

y_predict = model.predict(x_test)
print('accuracy_score : ', accuracy_score(y_test, y_predict)) #accuracy_score :  0.9


y_pred_best = model.best_estimator_.predict(x_test) 
print("최적 튠 ACC: ", accuracy_score(y_test, y_pred_best)) # 최적 튠 ACC:  0.9
