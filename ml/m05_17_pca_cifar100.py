...
for i in range(0, len(n), 1) :
    ...
    path_save = 'C:\\ai5\\_save\\m05\\m05_17\\'
    filename ='{epoch:04d}-{val_loss:.4f}.hdf5'   #1000-0.7777.hdf5
    filepath = "".join([path_save, 'm05_17_', str(i+1), '_', date, '_' , filename])
...
##############################################
# 결과.PCA : 202
# loss :  3.260903835296631
# ACC :  0.2335
# 걸린 시간 :  3.56 초
# ##############################################
# 결과.PCA : 659
# loss :  3.3467366695404053
# ACC :  0.2144
# 걸린 시간 :  2.99 초
# ##############################################
# 결과.PCA : 1481
# loss :  3.438242197036743
# ACC :  0.1953
# 걸린 시간 :  3.49 초
# ##############################################
# 결과.PCA : 3072
# loss :  3.4949893951416016
# ACC :  0.1818
# 걸린 시간 :  6.53 초