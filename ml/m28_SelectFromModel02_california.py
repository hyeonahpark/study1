...
x_train, x_test, y_train, y_test = train_test_split(x, y, random_state=3377, test_size=0.1)
...
# 최종점수 :  0.8099081396078877
# acc score : 0.8099081396078877

# Trech=0.032, n=8, ACC=79.41%
# Trech=0.036, n=7, ACC=80.13%
# Trech=0.051, n=6, ACC=81.23%
# Trech=0.071, n=5, ACC=79.35%
# Trech=0.099, n=4, ACC=78.59%
# Trech=0.115, n=3, ACC=62.69%
# Trech=0.141, n=2, ACC=45.79%
# Trech=0.455, n=1, ACC=47.09%