...
for i in range(0, len(n), 1) :
    ...
    hist=model.fit(x_train1, y_train, epochs=1000, batch_size=32, verbose = 0, validation_split=0.3, callbacks=[es])
    end_time=time.time()
...
########################## PF #############################
#결과.PCA : 8
#loss :  0.42902374267578125
#ACC :  0.833

#결과.PCA : 1
#loss :  0.589316725730896
#ACC :  0.636
#걸린 시간 :  5.07 초

#결과.PCA : 1
#loss :  0.5866448283195496
#ACC :  0.636
#걸린 시간 :  5.72 초

#결과.PCA : 8
#loss :  0.4838518798351288
#ACC :  0.636
#걸린 시간 :  3.94 초