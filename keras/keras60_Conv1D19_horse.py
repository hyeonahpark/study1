...
end_time=time.time()
print("데이터 처리 걸린 시간 :", round(end_time-start_time,2),'초') #10.08초


# #2. modeling
model = Sequential()
model.add(Conv1D(64, (3), input_shape=(200*200, 3), padding='same')) 
...
path = 'C:\\ai5\\_save\\keras60\\k60_19\\'
filename ='{epoch:04d}-{val_loss:.4f}.hdf5'   #1000-0.7777.hdf5
filepath = "".join([path, 'k60_19_', date, '_' , filename])
