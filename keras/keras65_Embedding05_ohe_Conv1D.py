...
model = Sequential()
model.add(Conv1D(30, (3), input_shape=(5, 31), padding='same')) 
...
print('준영이 생각보다 참 재미없다 :', np.round((y_pred)))


# Accuracy : 1.0000
# 1/1 [==============================] - 0s 61ms/step - loss: 3.0108e-05 - accuracy: 1.0000
# loss : 3.010791442648042e-05
# 태운이 참 재미없다 : [[0.]]

# Accuracy : 1.0000
# 1/1 [==============================] - 0s 61ms/step - loss: 2.5717e-05 - accuracy: 1.0000
# loss : 2.5717281459947117e-05
# 준영이 생각보다 참 재미없다 : [[0.]]