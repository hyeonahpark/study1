...
dense4 = Dense(32, name = 'ys4')(drop2)
dense5 = Dense(32, name = 'ys5')(dense4)
dense6 = Dense(32, name = 'ys6')(dense5)
dense7 = Dense(128, name = 'ys4')(dense6)
dense8 = Dense(64, name = 'ys5')(dense7)
dense9 = Dense(32, name = 'ys6')(dense8)
dense10 = Dense(2, name = 'ys6')(dense9)
