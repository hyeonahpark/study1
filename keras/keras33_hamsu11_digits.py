...
dense2 = Dense(200, name = 'ys2')(dense1)
drop1 = Dropout(0.3)(dense2)
dense3 = Dense(300, name = 'ys3')(drop1)
drop2 = Dropout(0.3)(dense3)
dense4 = Dense(600, name = 'ys4')(drop2)
dense5 = Dense(300, name = 'ys5')(dense4)
dense6 = Dense(200, name = 'ys6')(dense5)
dense7 = Dense(100, name = 'ys4')(dense6)
output1 = Dense(10)(dense7)
