...
from tensorflow.keras.layers import LSTM, Dense, Flatten, GRU, Bidirectional
import time
...
model.add(Bidirectional(LSTM(64, return_sequences=True), input_shape=(144,13))) # timesteps , features
model.add(Bidirectional(LSTM(128, return_sequences=True))) # timesteps , features
model.add(LSTM(256))
