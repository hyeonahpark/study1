...
path = 'C:\\ai5\\_save\\keras49\\k49_03_cifar10\\'
...
hist=model.fit(x_train, y_train, epochs=1000, batch_size=400, validation_split=0.3, callbacks=[es, mcp])
end_time=time.time()
