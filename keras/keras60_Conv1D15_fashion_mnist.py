...
from tensorflow.keras.layers import Dense, Conv1D, BatchNormalization #이미지 작업 Convolution2D == Conv2D (1D : 선, 3D : 입체형태)
...
path = 'C:\\ai5\\_save\\keras60\\k60_15\\'
filename ='{epoch:04d}-{val_loss:.4f}.hdf5'   #1000-0.7777.hdf5
filepath = "".join([path, 'k60_15_', date, '_' , filename])
