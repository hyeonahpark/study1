...
model.fit(x_train, y_train, epochs=1000, batch_size=512, verbose=1, validation_split=0.1, callbacks=[es])
end_time=time.time()
...
#====================================================minmax
#loss :  0.11063654720783234. ACC :  0.961

#====================================================standard
#loss :  0.10764724016189575 ACC :  0.963

# max
#loss :  0.11985476315021515 ACC :  0.958
