...
dense2 = Dense(600, name = 'ys2')(dense1)
drop1 = Dropout(0.3)(dense2)
dense3 = Dense(800, name = 'ys3')(drop1)
drop2 = Dropout(0.3)(dense3)
dense4 = Dense(1000, name = 'ys4')(drop2)
dense5 = Dense(800, name = 'ys5')(dense4)
dense6 = Dense(600, name = 'ys6')(dense5)
dense7 = Dense(400, name = 'ys7')(dense6)
dense8 = Dense(200, name = 'ys8')(dense7)
dense9 = Dense(100, name = 'ys9')(dense8)
