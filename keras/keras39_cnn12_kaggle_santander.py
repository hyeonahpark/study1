...
model=Sequential()
model.add(Conv2D(64, (3,3), activation='relu', input_shape=(50, 4, 1), padding='same')) 
...
path = 'C:\\ai5\\_save\\keras39\\k39_12\\'
...
model.save('./_save/keras39/k39_12/keras39_12_mcp.hdf5')
