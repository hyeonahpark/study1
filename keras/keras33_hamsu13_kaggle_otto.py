...
dense1 = Dense(1024, name = 'ys1')(input1)
drop1 = Dropout(0.3)(dense1)
dense2 = Dense(512, name = 'ys2')(drop1)
drop2 = Dropout(0.3)(dense2)
dense3 = Dense(256, name = 'ys3')(drop2)
drop3 = Dropout(0.3)(dense3)
dense4 = Dense(128, name = 'ys4')(drop3)
drop4 = Dropout(0.3)(dense4)
dense5 = Dense(64, name = 'ys5')(drop4)
drop5 = Dropout(0.3)(dense5)
dense6 = Dense(64, name = 'ys6')(drop5)
drop6 = Dropout(0.3)(dense6)
dense7 = Dense(64, name = 'ys7')(drop6)
drop7 = Dropout(0.3)(dense7)
dense8 = Dense(32, name = 'ys8')(drop7)
drop8 = Dropout(0.3)(dense8)
dense9 = Dense(32, name = 'ys9')(drop8)
drop9 = Dropout(0.3)(dense9)
dense10 = Dense(32, name = 'ys10')(drop9)
drop10 = Dropout(0.3)(dense10)
dense11 = Dense(16, name = 'ys11')(drop10)
drop11 = Dropout(0.3)(dense11)
dense12 = Dense(16, name = 'ys12')(drop11)
drop12 = Dropout(0.3)(dense12)
dense13 = Dense(16, name = 'ys13')(drop12)
drop13 = Dropout(0.3)(dense13)
output1 = Dense(9, activation='softmax')(drop13)
...
path = 'C:\\ai5\\_save\\keras32\\k32_13\\'
...
model.save('./_save/keras32/k32_13/keras32_13_mcp.hdf5')
