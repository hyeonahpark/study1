...
dense2 = Dense(512, name = 'ys2')(dense1)
drop1 = Dropout(0.3)(dense2)
dense3 = Dense(256, name = 'ys3')(drop1)
drop2 = Dropout(0.3)(dense3)
dense4 = Dense(128, name = 'ys4')(drop2)
dense5 = Dense(64, name = 'ys5')(dense4)
dense6 = Dense(64, name = 'ys6')(dense5)
dense7 = Dense(64, name = 'ys7')(dense6)
dense8 = Dense(32, name = 'ys8')(dense7)
dense9 = Dense(32, name = 'ys9')(dense8)
dense10 = Dense(32, name = 'ys10')(dense9)
dense11 = Dense(16, name = 'ys11')(dense10)
dense12 = Dense(16, name = 'ys12')(dense11)
dense13 = Dense(16, name = 'ys13')(dense12)
output1 = Dense(9)(dense13)
